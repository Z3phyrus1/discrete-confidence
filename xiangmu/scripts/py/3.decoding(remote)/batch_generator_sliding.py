# -*- coding: utf-8 -*-
"""
Created on Wed Apr  1 10:25:19 2026
...
subjects_list = [f"sub{i:02d}" for i in range(18, 29)]
trials_list = ["1"]

source_script = "sliding_script.py"
dependencies = ["utils.py", "common_settings.py"]
scripts_output_dir = "../bash_decoding_jobs"
...
def main():
    ...
    for dep in dependencies:
        if not os.path.exists(dep):
            raise FileNotFoundError(f"Missing dependency in current folder: {dep}")
