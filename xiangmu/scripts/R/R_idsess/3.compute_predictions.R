...
# ------------------------------------------------------#
# load data
d <- read.table("D:/xiangmu/data/behavior/idsess/data_nu.txt",header=T, sep=";")#D:/reysy/EEG/data/data_nu.txt
...
# ------------------------------------------------------#
# store results
write.table(d, file="D:/xiangmu/data/behavior/idsess/data_wide_wmPred.txt",quote=F,sep=";",row.names=F)#D:/reysy/EEG/data/data_wide_wmPred.txt
